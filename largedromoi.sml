...
fun parse file =
 	let
        ...
        fun readInt input = Option.valOf (TextIO.scanStream (Int64.scan StringCvt.DEC) input)
	...
	fun merge ([], M) = M
  | merge (L:(Int64.int*Int64.int*place)list, []) = L
  | merge (L as ((a,b,c)::xs), M as ((d,e,f)::ys)) =
	...
	fun sort [] = []
  | sort [x] = [x]
  | sort xs:(Int64.int*Int64.int*place)list =
    let
        val (ys, zs) = split xs
    in
	...
	fun check_days ( _ ,_, true, _ , _ , _ , _ )=true
	  ...
	  | check_days (last:Int64.int,0:Int64.int,false,list as (a:Int64.int,b:Int64.int,c)::tail,wanted:Int64.int,days:Int64.int,mikos:Int64.int)=
	...
	fun binsearch (1:Int64.int,1:Int64.int,list:(Int64.int*Int64.int*place)list,problem:Int64.int,tlength:Int64.int) =
	...
	val slist=sort list
	in
	binsearch (1:Int64.int,meres,slist,problem,mikos)
	end